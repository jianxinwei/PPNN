...
from models.RPCWorker import Worker
...
if __name__ == '__main__':
    ...
    torch.save(net_glob, './save/rpc_decentralized_bank.pkl')
    ...
    plt.xlabel('epoch')
    plt.savefig('./save/bank_rpc_decentralized_{}_{}.png'.format(args.model, args.epochs))

    # testing
    train_loader = DataLoader(dataset=TensorDataset(train_attributes, train_labels), batch_size=args.bs, shuffle=True)
    # net_glob = torch.load('./save/rpc_decentralized_bank.pkl')
    net_glob.eval()
