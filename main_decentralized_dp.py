...
if __name__ == '__main__':
    ...
    torch.save(net_glob, './save/decentralized_dp_bank.pkl')
    ...
    plt.xlabel('epoch')
    plt.savefig('./save/bank_decentralized_dp_{}_{}.png'.format(args.model, args.epochs))

    # testing
    train_loader = DataLoader(dataset=TensorDataset(train_attributes, train_labels), batch_size=args.bs, shuffle=True)
    # net_glob = torch.load('./save/decentralized_dp_bank.pkl')
    net_glob.eval()
