...
# new_bank.to_csv(os.path.join(os.path.split(bank_path)[0], 'new_bank_random_whole.csv'), sep=';', index=False)
new_bank.to_csv(os.path.join('../data/bank_random', 'new_bank_random_whole.csv'), sep=';', index=False)